    ...
    <body>
        ...
        <main>
            <section style="padding: 2%">
                <h1 class="uk-heading-large">Commission des Finances Châtillon</h1>
                <hr>
                <div class="uk-child-width-1-1@m uk-grid-small uk-grid-match" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="<?php echo $ChatillonFinancesLégislature19_23 ?>">
                                <div class="uk-card-body">
                                        <div class="uk-width-expand">
                                            <h3 class="uk-card-title uk-margin-remove-bottom montserrat
                                            uk-text-center">Législature 2019 - 2023</h3>
                                        </div>
                                </div>
                            </a>
                        </div>      

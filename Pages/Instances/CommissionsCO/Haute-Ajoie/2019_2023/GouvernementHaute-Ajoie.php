...
<head>
        ...
        <title>JuraVote | Conseil communal Haute-Ajoie</title>
        <meta charset="utf-8">
...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Conseil communal 2019 - 2023 Haute-Ajoie</h1>
        <hr>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Michel Baconat</h3>
                        <p>Administration générale, action sociale, urbanisme, police, relations publiques</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        ...
                        <p>Finances, économie publique, tourisme</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    <div class="uk-card-badge uk-label badge uk-border-rounded"></div><br>
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Joseph Lachat</h3>
                        <p>Travaux publics, service de la voirie, éclairage public</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        ...
                        <p>Service des eaux et eaux usées, jeunesse, culture, sports, vie sociale</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    <div class="uk-card-badge uk-label badge uk-border-rounded"></div><br>
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Etienne Oeuvray</h3>
                        <p>Agriculture et cimetière</p>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        ...
                        <p>Forêts, enviropnnement, gestion des déchets, service du feu, protection civile</p>
                    </div>
                </div>
            </div>
        </div>

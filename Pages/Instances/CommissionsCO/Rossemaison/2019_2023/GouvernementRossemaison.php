...
<head>
        ...
        <title>JuraVote | Conseil communal Rossemaison</title>
        <meta charset="utf-8">
...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Conseil communal 2019 - 2023 Rossemaison</h1>
        <hr>
        <div class="uk-child-width-1-3@xl uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        ...
                        <p>Mairie, administration, bourgeoisie, finances</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Marie-Madeleine Chappuis</h3>
                        <p>Affaires sociales, bâtiments, déchetterie, forêts</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        ...
                        <p>Patrimoine, travaux publics, voirie</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    <div class="uk-card-badge uk-label badge uk-border-rounded"></div><br>
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Catherine Löwenguth</h3>
                        <p>Ecole et sports</p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Alain Tissot</h3>
                        <p>Eaux, électricité, gaz, éclairage public</p>
                    </div>
                </div>
            </div>
    </section>

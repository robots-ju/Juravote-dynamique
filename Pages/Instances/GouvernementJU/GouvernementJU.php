                ...
                <div class="uk-child-width-1-2@m uk-grid-small uk-grid-match" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="<?php echo $PHPGouvernementJU20212025 ?>">
                                <div class="uk-card-body">
                                        <div class="uk-width-expand">
                                            <h3 class="uk-card-title uk-margin-remove-bottom montserrat
                                            uk-text-center">Législature 2021 - 2025</h3>
                                        </div>
                                </div>
                            </a>
                        </div>      
                    ...
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="<?php echo $PHPGouvernementJU20162020 ?>">
                                <div class="uk-card-body">
                                        <div class="uk-width-expand">
                                            <h3 class="uk-card-title uk-margin-remove-bottom montserrat
                                            uk-text-center">Législature 2016 - 2020</h3>
                                        </div>
                                </div>
                            </a>
                        </div>      

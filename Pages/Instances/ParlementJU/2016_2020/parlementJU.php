...
<head>
        ...
        <title>JuraVote | Parlement jurassien 2016 - 2020</title>
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="<?php echo $cssparlementJU; ?>"/>
...
<section style="padding: 2%">
        <h1 class="uk-heading-large">Parlement jurassien 2016 - 2020</h1>
        <hr>
        ...
        <div class="uk-child-width-1-5@xl uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
                ...
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-header">
                        <div class="uk-grid-small uk-flex-column uk-grid uk-grid-stack" uk-grid>
                            <div class="uk-width-auto uk-first-column">
                                <img class="uk-border-circle photo-personne"
                                     src="../../../../IMG/Personnalites/ParlementJU/2016_2020/StephaneTheurillat.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="uk-card-body">
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-hover uk-text-center">
                    ...
                    <div class="uk-card-body">
                        <h3 class="uk-card-title-center text-rouge-fonce">Ivan Godat</h3>
                    </div>
                </div> 
            </div>
            <div>

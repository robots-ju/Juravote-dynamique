...
<head>
        ...
        <title>JuraVote | Elections Conseil communal Montfaucon</title>
        <meta charset="utf-8">
...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Montfaucon - élections au Conseil communal</h1>
        <hr>
        <h2 style="padding-bottom: 2%;">Délai de dépôt des listes</h2>
        <p>Les fonctions de Conseillers communaux (H/F) sont à repourvoir en date du 13 juin prochain.
        A cet effet, deux élections complémentaires (lors de démission de l'élu en cours de mandat) par les urnes 
        sont organisées.</p>
        <p>Les citoyens (H/F) intéressés à faire acte de candidature sont invités à bien vouloir remettre au Conseil
        communal leur postulation (avec indication du nom, du prénom, de l'année de naissance

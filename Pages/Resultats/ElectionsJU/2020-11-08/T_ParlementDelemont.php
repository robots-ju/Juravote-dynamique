            ...
            <li>
                <div class="uk-child-width-1-3@l uk-child-width-1-3@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
                    ...
                    <div>
                        ...
                        <div id="modal-full-29" class="uk-modal-full uk-text-justify" uk-modal>
                            <div class="uk-modal-dialog">
                                <button class="uk-modal-close-full uk-close-large" type="button" uk-close></button>
                                <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                                    <div class="uk-background-cover" style="background-image: url(<?php echo $VollmerColin ?>);" uk-height-viewport></div>
                                    <div class="uk-padding-large">
                                    <h2>Colin Vollmer, 1997, Delémont, Etudiant-collaborateur politique</h2>
                                    <p>Célibataire, pas d'enfants, Bachelor en Sciences de la communication et des médias</p>
                                        <div class="switcher-buttons uk-text-left" uk-switcher="animation: uk-animation-fade; toggle: > *" style="padding-bottom: 2%">
                                            <button class="uk-button uk-button-default" type="button">Présentation</button>
                                            <button class="uk-button uk-button-default" type="button">Votations du 27 septembre</button> 
                                            <button class="uk-button uk-button-default" type="button">Votations du 29 novembre</button>
                                        ...
                                        <ul class="uk-switcher uk-margin">
                                            <li>
                                                <h4>Motivations</h4>
                                                <p>M'engager pour la solidarité, l'écologie, la jeunesse, le respect, bref pour un Jura
                                                    où chacun-e trouve la place qui lui revient ! </p>

                                                <h4>Priorités politiques</h4>
                                                <p>Transports publics gratuits jusqu'à 25 ans, amélioration des offres de bourses
                                                    d'études, neutralité carbone et défense de la jeunesse. </p>

                                                <h4>Vos loisirs</h4>
                                                <p>Scoutisme, lecture, promenades, politique.</p>

                                                <h4>Vos réseaux sociaux</h4>
                                                <a href="https://twitter.com/ColinVollmer" target="_blank" uk-icon="icon: twitter; ratio: 2"></a>                                                
                                            </li>
                                            ...
                                            <li>          
                                                ...
                                                <p>Favorable à une caisse-maladie unique au niveau romand/suisse.</p>                                           
                                            </li>
            ...
            <li>
                <div class="uk-child-width-1-3@l uk-child-width-1-3@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
                    ...
                    <div>
                        ...
                        <div id="modal-full-28" class="uk-modal-full uk-text-justify" uk-modal>
                            <div class="uk-modal-dialog">
                                <button class="uk-modal-close-full uk-close-large" type="button" uk-close></button>
                                <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                                    <div class="uk-background-cover" style="background-image: url(<?php echo $VoutatAudrey ?>);" uk-height-viewport></div>
                                    <div class="uk-padding-large">
                                    <h2>Audrey Voutat, 1989, Rossemaison, Avocate</h2>
                                    <p>Mariée, 2 enfants, Etudes en droit</p>
                                        <div class="switcher-buttons uk-text-left" uk-switcher="animation: uk-animation-fade; toggle: > *" style="padding-bottom: 2%">
                                            <button class="uk-button uk-button-default" type="button">Présentation</button>
                                            <button class="uk-button uk-button-default" type="button">Votations du 27 septembre</button> 
                                            <button class="uk-button uk-button-default" type="button">Votations du 29 novembre</button>
                                        ...
                                        <ul class="uk-switcher uk-margin">
                                            <li>
                                                <h4>Motivations</h4>
                                                <p>Je souhaite mettre à profit mes compétences juridiques pour participer à la réflexion globale
                                                    qui doit être menée quant à nos modes de vie et notre société. Le démantèlement progressif
                                                    de l'Etat social et des différentes mesures constituant "le filet social" m'inquiète
                                                    particulièrement, de même que le réchauffement climatique. Par conséquent, il convient de
                                                    réfléchir à nos modes de vie, à notre société et l'endiguement d'une pauvreté croissante.
                                                    Je souhaite par conséquent m'y atteler avec ferveur.</p>

                                                <h4>Priorités politiques</h4>
                                                <p>Politique sociale et économique, Transition énergétique</p>

                                                <h4>Vos loisirs</h4>
                                                <p>Musique, jardinage, lectures, passer du temps de qualité avec ma famille</p>
                                            </li>
                    ...
                    <div>
                        ...
                        <div id="modal-full-30" class="uk-modal-full uk-text-justify" uk-modal>
                            <div class="uk-modal-dialog">
                                <button class="uk-modal-close-full uk-close-large" type="button" uk-close></button>
                                <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                                    <div class="uk-background-cover" style="background-image: url(<?php echo $BlaserFrederic ?>);" uk-height-viewport></div>
                                    <div class="uk-padding-large">
                                    <h2>Frédéric Blaser, 1975, Delémont, Responsable RH</h2>
                                    <p>Marié, 2 enfants, Université de Neuchâtel. Licence en Sciences Economiques</p>
                                        <div class="switcher-buttons uk-text-left" uk-switcher="animation: uk-animation-fade; toggle: > *" style="padding-bottom: 2%">
                                            <button class="uk-button uk-button-default" type="button">Présentation</button>
                                            <button class="uk-button uk-button-default" type="button">Votations du 27 septembre</button> 
                                            <button class="uk-button uk-button-default" type="button">Votations du 29 novembre</button>
                                        ...
                                        <ul class="uk-switcher uk-margin">
                                            <li>
                                                <h4>Motivations</h4>
                                                <p>Pour favoriser la mobilité douce et le développement durable de la pratique du VTT,
                                                    du cyclotourisme et des infrastructures cyclistes dans le canton du Jura.
                                                    Pour encourager les Jurassien.ne.s à accepter de prendre le virage énergétique pour
                                                    une sortie rapide des énergies fossiles. 
                                                    Pour une économie résiliente et socialement équitable.</p>

                                                <p>Parce qu’il y urgence à agir, je m’engage avec les Vert.e.s Jurassien.ne.s pour
                                                    contribuer à offrir à nos enfants un présent et un avenir sains et durables
                                                    empreints d’une plus grande justice sociale. </p>

                                                <h4>Priorités politiques</h4>
                                                <p>Adopter des résolutions tournés vers l'avenir en tenant compte des enjeux climatiques, sociaux et économiques. </p>

                                                <h4>Vos loisirs</h4>
                                                <p>Le sport en général, le VTT en qualité d'organisateur de courses et de pratiquant en particulier.</p>

                                                <h4>Vos réseaux sociaux</h4>
                                                <a href="https://www.facebook.com/frederic.blaser" target="_blank" uk-icon="icon: facebook; ratio: 2"></a></li>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <p>Il convient avant toute chose de mettre les conditions cadres en place afin de diminuer
                                                    notre consommation énergétique et ensuite de réfléchir à un approvisionnement local et
                                                    durable de l'énergie. Un mix énergétique est indispensable pour sortir des énergies
                                                    nucléaires et fossiles. Les projets éoliens et de géothermie  sont des solutions qu'il
                                                    convient de considérer conjointement avec les autres sources durables d'énergies.</p>
                                            </li>

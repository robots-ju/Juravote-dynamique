...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Résultat des votations fédérales du 28 septembre 2014</h1>
        <hr>
        <section>
                        ...
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat uk-text-center">
                                    Initiative populaire du 21.09.2011 «Stop à la TVA discriminatoire pour la restauration!» </h3>
                            </div>
                            </a>
                        </div>
                    </div>    
                        ...
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">
                                    Initiative populaire du 23.05.2012 «Pour une caisse publique d’assurance-maladie»</h3>
                            </div>
                            </a>
                        </div>
                    </div>

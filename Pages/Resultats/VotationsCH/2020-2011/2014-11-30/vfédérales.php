                ...
                <div class="uk-child-width-1-2@m uk-grid-small uk-grid-match" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="ForfaitsFiscaux.html">
                            <div class="uk-card-header">
                                <div class="uk-grid-small uk-flex-column uk-text-center" uk-grid>
                                    <div class="uk-width-auto ">
                                        <img src="#" width="200" height="200" alt="Initiative contre les privilèges fiscaux des millionnaires">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="Surpopulation.html">
                            <div class="uk-card-header">
                                <div class="uk-grid-small uk-flex-column uk-text-center" uk-grid>
                                    <div class="uk-width-auto">
                                        <img src="#" width="200" height="200" alt="Initiative halte à la surpopulation">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-card-body">
                    ...
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-header">
                                <div class="uk-grid-small uk-flex-column uk-text-center" uk-grid>
                                    <div class="uk-width-auto">
                                        <img src="#" width="200" height="200" alt="Initiative sur l'or">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-card-body">

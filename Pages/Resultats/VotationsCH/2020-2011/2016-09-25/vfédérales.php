...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Résultat des votations fédérales du 25 septembre 2016</h1>
        <hr>
        <section>
                ...
                <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match" uk-grid>
                        ...
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat uk-text-center">
                                    Initiative populaire du 06.09.2012 «Pour économie durable et fondée sur une
                                    gestion efficiente des ressources (économie verte)»</h3>
                            </div>
                            </a>
                        </div>
                    </div>    
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">Initiative populaire du 17.12.2013
                                    «AVSplus: pour une AVS forte»</h3>
                            </div>
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">Loi fédérale du 25.09.2015 sur le
                                    renseignement (LRens)</h3>
                            </div>
                            </a>
                        </div>
                    </div>

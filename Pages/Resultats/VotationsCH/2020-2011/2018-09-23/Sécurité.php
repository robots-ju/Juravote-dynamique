        ...
        <div class="uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body uk-text-left">
                        <p><b>Objet : </b>Initiative populaire du 26.11.2015
                            «Pour des denrées alimentaires saines et produites dans des conditions équitables et écologiques
                            (initiative pour des aliments équitables)»</p>
                        <p><b>Participation : </b>37.52 %</p>
            ...
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body">
                        <div id="chartSecurite" style="width: 100%; height: 250px;"></div>
                        <script>
                            // Create chart instance
                            var resultatSecurite = am4core.create("chartSecurite", am4charts.PieChart);

                            // Add data
                            resultatSecurite.data = [{
                                "votes": "OUI",
                                "suffrages": 774821
                            }, {
                                "votes": "NON",
                            ...
                            var dataSecurite = resultatSecurite.series.push(new am4charts.PieSeries());
                            dataSecurite.dataFields.value = "suffrages";
                            dataSecurite.dataFields.category = "votes";

                            // Let's cut a hole in our Pie chart the size of 40% the radius
                            resultatSecurite.innerRadius = am4core.percent(40);

                            // Disable ticks and labels
                            dataSecurite.labels.template.disabled = true;
                            dataSecurite.ticks.template.disabled = true;

                            // Disable tooltips
                            dataSecurite.slices.template.tooltipText = "";

                            // Add a legend
                            resultatSecurite.legend = new am4charts.Legend();
                            resultatSecurite.legend.position = "right";

                            dataSecurite.colors.list = [
            ...
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body">
                        <div class="uk-align-right" id="chartSecuritech" style="width: 100%; height: 300px;"></div>
                        <script>
                            // Create map instance
                            var resultatsSecuriteCH = am4core.create("chartSecuritech", am4maps.MapChart);

                            // Set map definition
                            resultatsSecuriteCH.geodata = am4geodata_switzerlandHigh;

                            // Set projection
                            resultatsSecuriteCH.projection = new am4maps.projections.Miller();

                            // Create map polygon series
                            var polygonSeries = resultatsSecuriteCH.series.push
                            ...
                            //Create data series
                            var série20to30 = resultatsSecuriteCH.series.push(new am4maps.MapPolygonSeries());
                            série20to30.name = "20 à 30 %";
                            série20to30.value = "20 à 30 %";
                            série20to30.title = "Oui en %";
                            série20to30.useGeodata = true;
                            série20to30.include = ["CH-LU", "CH-UR", "CH-SZ", "CH-OW", "CH-NW", "CH-ZG", "CH-AI",
                            ...
                            var série30to40 = resultatsSecuriteCH.series.push(new am4maps.MapPolygonSeries());
                            série30to40.name = "30 à 40 %";
                            série30to40.value = "30 à 40 %";
                            série30to40.title = "Oui en %";
                            série30to40.useGeodata = true;
                            série30to40.include = ["CH-ZH", "CH-BE", "CH-GL", "CH-SO", "CH-BL", "CH-SH", "CH-AR", "CH-VS"];
                            ...
                            var série40to50 = resultatsSecuriteCH.series.push(new am4maps.MapPolygonSeries());
                            ...
                            var série50to60 = resultatsSecuriteCH.series.push(new am4maps.MapPolygonSeries());
                            série50to60.name = "50 à 60 %";
                            série50to60.value = "50 à 60 %";
                            série50to60.title = "Oui en %";
                            série50to60.useGeodata = true;
                            série50to60.include = ["CH-NE", "CH-JU"]
                            ...
                            var série60to70 = resultatsSecuriteCH.series.push(new am4maps.MapPolygonSeries());
                            série60to70.name = "60 à 70 %";
                            série60to70.value = "60 à 70 %";
                            série60to70.title = "Oui en %";
                            série60to70.useGeodata = true;
                            série60to70.include = ["CH-VD", "CH-GE"];
                            ...
                            resultatsSecuriteCH.legend = new am4maps.Legend();
                            resultatsSecuriteCH.legend.position = "left";
                        </script>
                    </div>
                </div>
            </div>

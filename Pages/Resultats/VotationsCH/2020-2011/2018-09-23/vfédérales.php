...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Résultat des votations fédérales du 23 septembre 2018</h1>
        <hr>
        <section>
                ...
                <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match" uk-grid>
                        ...
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat uk-text-center">
                                    Arrêté fédéral du 13.03.2018 concernant les voies cyclables et les chemins et sentiers pédestres
                                    (contre-projet direct à l'initiative populaire «Pour la promotion des voies cyclables et des
                                    chemins et sentiers pédestres [initiative vélo]») </h3>
                            </div>
                            </a>
                        </div>
                    </div>    
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">Initiative populaire du 26.11.2015
                                    «Pour des denrées alimentaires saines et produites dans des conditions équitables et écologiques
                                    (initiative pour des aliments équitables)»</h3>
                            </div>
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">Initiative populaire du 30.03.2016
                                    «Pour la souveraineté alimentaire. L'agriculture nous concerne toutes et tous»</h3>
                            </div>
                            </a>
                        </div>
                    </div>

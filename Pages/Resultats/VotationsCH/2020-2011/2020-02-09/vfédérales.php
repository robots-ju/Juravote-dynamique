                ...
                <div class="uk-child-width-1-2@m uk-grid-small uk-grid-match" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="<?php echo $PHPvotationsCHLogements ?>">
                            ...
                            <div class="uk-card-body">
                                ...
                                Initiative populaire du 18 octobre 2016 "Davantage de logements abordables"</h3>
                            </div>
                            </a>
                        </div>
                    </div>    
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover">
                            <a href="<?php echo $PHPvotationsCHDiscrimination ?>">
                            <div class="uk-card-header">
                                <div class="uk-grid-small uk-flex-column uk-text-center" uk-grid>
                                    <div class="uk-width-auto">
                            ...
                            <div class="uk-card-body">
                                <h3 class="uk-card-title uk-margin-remove-bottom montserrat">Modification du 14
                                    décembre 2018 du code pénal et du code pénal militaire (Discrimination et
                                    incitation à la haine en raison de l'orientation sexuelle)</h3>
                            </div>
                            </a>
                        </div>
                    </div>

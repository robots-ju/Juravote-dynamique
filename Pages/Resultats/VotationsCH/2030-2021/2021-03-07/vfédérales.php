...
<main>
    <section style="padding: 2%">
        <h1 class="uk-heading-large">Résultats des votations fédérales du 7 mars 2021</h1>
        <hr>
        <section>
            <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match" uk-grid>
                <div>
                    <div class="uk-card uk-card-default uk-card-hover">
                        <a href="<?php echo $PHPresultats20210307Voile ?>">
                ...
                <div>
                    <div class="uk-card uk-card-default uk-card-hover">
                        <a href="<?php echo $PHPresultats20210307LSIE ?>">
                            <div class="uk-card-header">
                                <div class="uk-width-auto">
                ...
                <div>
                    <div class="uk-card uk-card-default uk-card-hover">
                        <a href="<?php echo $PHPresultats20210307AELE ?>">
                            <div class="uk-card-header">
                                <div class="uk-width-auto">

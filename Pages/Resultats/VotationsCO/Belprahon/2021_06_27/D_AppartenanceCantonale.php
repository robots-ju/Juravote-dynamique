...
<head>
        ...
        <title>JuraVote | Votation Belprahon</title>
        <meta charset="utf-8">
...
<header>
    ...
    <section class="uk-text-justify" style="padding: 2%;">
        <h1 class="uk-heading-large">Votation Belprahon du 27 juin 2021</h1>
        <hr>
        <h3 style="padding-bottom: 12%;">Les informations sur la votation de l'appartenance cantonale de Belprahon seront
        bientôt disponibles !</h3>

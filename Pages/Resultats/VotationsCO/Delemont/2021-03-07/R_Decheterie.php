...
<head>
        ...
        <title>JuraVote | Votation Delémont du 7 mars 2021</title>
        <meta charset="utf-8">
                ...
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body">
                        <div class="uk-grid-small uk-align-center" uk-grid>
                            <iframe title="Modification du Plan d'aménagement local destiné au projet de déchèterie aux Prés-Roses" aria-label="chart" id="datawrapper-chart-COR2o" src="https://datawrapper.dwcdn.net/COR2o/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="323"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                            </script>                          
                        </div>
                    </div>
                </div>

        ...
        <div class="uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-small uk-grid-match" uk-grid>
            ...
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <section style="padding: 2%;">
                        <iframe title="Crédit de CHF 1'312'000.- nécessaire à l'assainissement du Centre de Culture et de Sport à Courfaivre" aria-label="chart" id="datawrapper-chart-72bwz" src="https://datawrapper.dwcdn.net/72bwz/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="323"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    </section>
                </div>
            </div>

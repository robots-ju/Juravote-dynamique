            ...
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body uk-text-left">
                        ...
                        <p><a href="Creche_description.php">Lien vers la description du projet</a></p>
                    </div>
                </div>
            </div>
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <section style="padding: 2%;">
                        <iframe title="Demande de crédit de CHF 2'150'000.- pour l'acquisition d'un bâtiment à Courfaivre pour l'accueil d'une antenne crèche/UAPE à Courfaivre" aria-label="chart" id="datawrapper-chart-Bfl9o" src="https://datawrapper.dwcdn.net/Bfl9o/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="323"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    </section>
                </div>
            </div>

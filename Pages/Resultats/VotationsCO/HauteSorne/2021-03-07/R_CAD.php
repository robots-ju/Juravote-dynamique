            ...
            <div>
                <div class="uk-card uk-card-default">
                    ...
                    <div style="padding-top: 0.5%" class="uk-card-body">
                        <iframe title="Crédit d’investissement de CHF 1'202'195.- pour la mise en place d’une nouvelle chaufferie alimentant les bâtiments de l’administration communale et le complexe scolaire de Bassecourt" aria-label="chart" id="datawrapper-chart-W4dU7" src="https://datawrapper.dwcdn.net/W4dU7/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="368"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    </div>
                </div>
            </div>

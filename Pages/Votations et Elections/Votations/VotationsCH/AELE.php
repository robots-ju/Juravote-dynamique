...
<html lang="fr">
    <head>
        ...
        <title>JuraVote | Arrêté fédéral du 20 décembre 2019 portant approbation de l’Accord de partenariat économique de large portée entre les États de l’AELE et l’Indonésie</title>
        <meta charset="utf-8">
            ...
            <ul class="uk-switcher uk-margin">
                ...
                <li>
                    <div class="uk-column-1-3@m uk-column-1-1@s">
                        ...
                        <iframe title="Recommandations de vote des partis fédéraux_AELE" aria-label="chart" id="datawrapper-chart-2LMpP" src="https://datawrapper.dwcdn.net/2LMpP/4/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>   

                        <!--<h2>Partis jurassiens</h2>-->
                        <iframe title="Recommandations de vote des partis jurassiens_AELE" aria-label="chart" id="datawrapper-chart-x8tEf" src="https://datawrapper.dwcdn.net/x8tEf/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    

                        <!--<h2>Autorités</h2>-->
                        <iframe title="Recommandations de vote des Autorités_AELE" aria-label="chart" id="datawrapper-chart-71tcb" src="https://datawrapper.dwcdn.net/71tcb/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    </div>
                </li>  
                <li>            

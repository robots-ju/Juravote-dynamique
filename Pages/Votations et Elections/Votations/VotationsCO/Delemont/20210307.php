        ...
        <ul class="uk-switcher uk-margin">
            <li> 
                <div class="uk-column-1-2@m uk-column-1-1@s">
                    ...
                    <img src="<?php echo $CentreEntretienRCJU ?>" style="width: 500px" class="uk-align-center">
                    <p class="uk-text-center"><i>Photo : République et Canton du Jura, 2009</i></p>
                </div>
            ...
            <li>
                <div class="uk-child-width-1-2@m" uk-grid>
                    <div>
                        <h2>Autorités</h2>
                        <iframe title="Recommandations de vote des autorités" aria-label="chart" id="datawrapper-chart-NxQPK" src="https://datawrapper.dwcdn.net/NxQPK/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                        </script>
                    </div>

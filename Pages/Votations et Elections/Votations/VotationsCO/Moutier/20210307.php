            ...
            <ul class="uk-switcher uk-margin">
                        ...
                        <table class="uk-table uk-table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="uk-text-right">3'413.00</td>
                                    <td class="uk-text-right">3'413.00</td>
                                    <td class="uk-text-right"><b>3'413.00</b></td>
                                </tr>
                ...
                <li>         
                    <div class="uk-child-width-1-2@m" uk-grid>
                        <div>
                            <h2>Autorités</h2>             
                            <iframe title="Recommandations de vote des autorités de Moutier" aria-label="chart" id="datawrapper-chart-ticQ2" src="https://datawrapper.dwcdn.net/ticQ2/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
                            </script> 
                        </div>

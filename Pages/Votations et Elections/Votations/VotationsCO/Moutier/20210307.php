...
<header>
    ...
    <section class="uk-text-justify" style="padding: 2%;">
        <h1 class="uk-heading-large">Votation Moutier du 7 mars 2021</h1>
        <hr>
        <h3 class="uk-text-center">Les informations seront disponibles au milieu du mois de février !</h3>
